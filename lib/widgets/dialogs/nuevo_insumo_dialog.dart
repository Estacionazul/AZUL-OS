...
class NuevoInsumoDialog extends StatefulWidget {
  ...
  const NuevoInsumoDialog({super.key, this.insumo});
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem(value: "☕", child: Text("☕ Café")),
                    DropdownMenuItem(value: "🥛", child: Text("🥛 Lácteo")),
                    DropdownMenuItem(value: "🥤", child: Text("🥤 Bebida")),
                    DropdownMenuItem(value: "🍞", child: Text("🍞 Pan")),
                    DropdownMenuItem(value: "🍫", child: Text("🍫 Chocolate")),
                    DropdownMenuItem(value: "🧂", child: Text("🧂 Insumo")),
                  ],
                  onChanged: (value) {
                    setState(() {
                      _emoji = value!;
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: _guardando
              ...
              : Text(widget.insumo == null ? "Guardar" : "Actualizar"),
        ),
      ],
    );
  }
