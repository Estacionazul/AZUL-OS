...
class _RecetasScreenState extends State<RecetasScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                const ModuleHeader(
                  ...
                  title: 'Recetas',
                  subtitle: 'Gestiona las recetas y sus ingredientes',
                ),
                  ...
                  children: [
                    Expanded(
                      child: DashboardStatCard(
                        ...
                        titulo: "Total",
                        valor: service.totalRecetas.toString(),
                        color: Colors.blue,
                      ),
                    ),
                    ...
                    Expanded(
                      child: DashboardStatCard(
                        ...
                        titulo: "Activas",
                        valor: service.recetasActivas.toString(),
                        color: Colors.green,
                      ),
                    ),
                    ...
                    Expanded(
                      child: DashboardStatCard(
                        icon: Icons.cancel,
                        titulo: "Inactivas",
                        valor: service.recetasInactivas.toString(),
                        color: Colors.red,
                      ),
                    ),
                  ],
  ...
  Widget _buildListaRecetas(RecetasService service) {
  ...
  Future<void> _confirmarEliminar(int id) async {
    ...
    if (confirmar == true && mounted) {
      await context.read<RecetasService>().eliminarReceta(id);
    }
  }
}