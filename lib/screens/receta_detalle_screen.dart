...
class _RecetaDetalleScreenState extends State<RecetaDetalleScreen> {
  ...
  Widget build(BuildContext context) {
    final producto = context.watch<ProductoService>().obtenerProducto(
        ...
        return Scaffold(
              ...
              children: [
                Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text(
                      producto?.nombre ?? widget.receta.nombre,
                ...
                Expanded(
                  child: service.ingredientes.isEmpty
                      ? const Center(
                          child: Text("Esta receta aún no tiene ingredientes."),
                        )
          ...
          floatingActionButton: FloatingActionButton.extended(
            onPressed: () async {
              await showDialog(
                context: context,
                builder: (_) => AgregarIngredienteDialog(receta: widget.receta),
              );
  ...
  Widget _buildIngredientes(RecetaDetalleService service) {
    return ListView.separated(
      itemCount: service.ingredientes.length,
      separatorBuilder: (_, __) => const SizedBox(height: 10),
      itemBuilder: (context, index) {
        final ingrediente = service.ingredientes[index];
        ...
        return Card(
          ...
          child: ListTile(
            ...
            title: FutureBuilder(
              future: context.read<InsumoService>().obtenerPorId(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () async {
                    ...
                    await service.cargarIngredientes(widget.receta.id!);
                  },
                ),
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    ...
                    if (confirmar == true) {
                      await service.eliminarIngrediente(ingrediente);
