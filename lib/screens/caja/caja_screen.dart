...
class _CajaScreenState extends State<CajaScreen> {
  ...
  Future<void> _registrarMovimientoManual({
            ...
            child: Column(
              ...
              children: [
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Concepto',
                    hintText: 'Ej. Cambio de sencillo',
                    border: OutlineInputBorder(),
                  ),
                ),
    ...
    await _repository.registrarMovimiento(
      MovimientosCajaCompanion(
        cajaId: Value(caja.id),
        tipo: Value(
          esIngreso ? 'INGRESO' : 'EGRESO',
        ),
        concepto: Value(concepto),
        monto: Value(monto),
        metodoPago: const Value('EFECTIVO'),
        referencia: const Value(null),
        observacion: const Value(null),
      ),
    );
