...
class Empresa extends Table {
  ...
  TextColumn get serieBoleta => text().withDefault(const Constant('B001'))();

  TextColumn get serieFactura => text().withDefault(const Constant('F001'))();

  IntColumn get correlativoBoleta => integer().withDefault(const Constant(1))();

  IntColumn get correlativoFactura =>
      integer().withDefault(const Constant(1))();

  RealColumn get igv => real().withDefault(const Constant(18))();
